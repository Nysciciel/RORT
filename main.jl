...
function main(filename::String)
    ...
    function_activation1 = @constraint(model, [i=1:nb_nodes,f=1:nb_functions], 100*u[i,f] >= y[i,f], base_name="function_activation1")
    ...
    exclusion = @constraint(model, [i in 1:nb_nodes, index in size(excl,1); excl[index,1]!=0], y[i,excl[index,1]] <= 100*(1-u[i,excl[index,2]]), base_name="exclusion")
